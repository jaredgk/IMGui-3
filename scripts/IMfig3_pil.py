...
def scancommandline(args):
    ...
    cldic = {'a':aflag,'b':bflag,'c':cflag,'d':dflag,'e':eflag,'f':fflag,\
             ...
             'x':xflag,'y':yflag}
    flags_must_use = 'i'
    flags_with_values =  "cbfghimoptxyn"
...
def setdefaults():
    ...
    gv = {"label_a_pops":False,"simplecolor":False,"dosquare":False,
        ...
        "anglenames":False,"dashinterval":3,"usealtnames":False,"imagefileextension":"","altnamefilename":"","altpopnames":[]
         }
